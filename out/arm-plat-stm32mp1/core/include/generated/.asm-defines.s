	...
	.file	"asm-defines.c"
@ GNU C99 (Arm GNU Toolchain 11.3.Rel1) version 11.3.1 20220712 (arm-none-linux-gnueabihf)
...
@ options passed: -mcpu=cortex-a7 -mfloat-abi=soft -mthumb -mno-unaligned-access -mfpu=neon -mtls-dialect=gnu -march=armv7ve -g3 -O0 -std=gnu99 -ffunction-sections -fdata-sections -fno-short-enums -fno-common
	.text
.Ltext0:
...
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:100: 	DEFINE(THREAD_CTX_SIZE, sizeof(struct thread_ctx));
	.loc 1 100 2
@ 100 "core/arch/arm/kernel/asm-defines.c" 1
	
.ascii "==>THREAD_CTX_SIZE 784 sizeof(struct thread_ctx)"	@
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:107: 	DEFINE(THREAD_CORE_LOCAL_TMP_STACK_VA_END,
	.loc 1 107 2
...
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:109: 	DEFINE(THREAD_CORE_LOCAL_CURR_THREAD,
	.loc 1 109 2
...
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:111: 	DEFINE(THREAD_CORE_LOCAL_FLAGS,
	.loc 1 111 2
@ 111 "core/arch/arm/kernel/asm-defines.c" 1
	
.ascii "==>THREAD_CORE_LOCAL_FLAGS 20 offsetof(struct thread_core_local, flags)"	@
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:113: 	DEFINE(THREAD_CORE_LOCAL_ABT_STACK_VA_END,
	.loc 1 113 2
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 2 "./out/arm-plat-stm32mp1/include/generated/conf.h"
	.byte	0x3
	.uleb128 0
	.uleb128 0x2
	.byte	0x7
	...
	.byte	0x4
	.file 13 "/opt/embedded/crosstools/arm-gnu-toolchain-11.3.rel1-x86_64-arm-none-linux-gnueabihf/lib/gcc/arm-none-linux-gnueabihf/11.3.1/include/stdbool.h"
	.byte	0x3
	.uleb128 0xc
	.uleb128 0xd
	.byte	0x7
	...
	.byte	0x4
	.file 14 "/opt/embedded/crosstools/arm-gnu-toolchain-11.3.rel1-x86_64-arm-none-linux-gnueabihf/lib/gcc/arm-none-linux-gnueabihf/11.3.1/include/stddef.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0xe
	.byte	0x7
	...
	.uleb128 0x6
	.4byte	.LASF1337
	.file 17 "/opt/embedded/crosstools/arm-gnu-toolchain-11.3.rel1-x86_64-arm-none-linux-gnueabihf/lib/gcc/arm-none-linux-gnueabihf/11.3.1/include/stdarg.h"
	.byte	0x3
	.uleb128 0x9
	.uleb128 0x11
	.byte	0x7
	...
	.file 26 "out/arm-plat-stm32mp1/core/include/generated/arm32_sysreg.h"
	.byte	0x3
	.uleb128 0xb0
	.uleb128 0x1a
	.byte	0x5
	...
	.byte	0x4
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.0.ca2e4198656a796e5fd50f19880e02db,comdat
.Ldebug_macro2:
	.2byte	0x5
	.byte	0
	.byte	0x5
	...
	.4byte	.LASF461
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.conf.h.2.48d361b5131360a71db49872af048d5f,comdat
.Ldebug_macro3:
	.2byte	0x5
	.byte	0
	.byte	0x5
...
.LASF462:
	.ascii	"_out_arm_plat_stm32mp1_include_generated_conf_h_ \000"
.LASF1684:
...
.LASF898:
	.ascii	"PRIx64 __PRI64_PREFIX \"x\"\000"
.LASF2212:
	.ascii	"GNU C99 11.3.1 20220712 -mcpu=cortex-a7 -mfloat-abi"
	.ascii	"=soft -mthumb -mno-unaligned-access -mfpu=neon -mtl"
	.ascii	"s-dialect=gnu -march=armv7ve -g3 -O0 -std=gnu99 -ff"
	.ascii	"unction-sections -fdata-sections -fno-short-enums -"
...
.LASF2214:
	.ascii	"/home/aom1/Work/Linux/target/STM32MP1-DK2/bootloade"
	.ascii	"r/buildroot/optee-os-custom\000"
.LASF1195:
